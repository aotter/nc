...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    useCssVars((_ctx) => ({
      "af01be54": unref(gridGap),
      "676a2fd9": unref(gridRows),
      "640029dd": unref(gridColumns)
    }));
