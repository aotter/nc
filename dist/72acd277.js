...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    useCssVars((_ctx) => ({
      "418c085c": unref(gridGap),
      "200b8dda": unref(gridRows),
      "55a1de63": unref(gridColumns)
    }));
