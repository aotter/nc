...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    useCssVars((_ctx) => ({
      "5c5da907": unref(aspectRatioCSSVariable)
    }));
    ...
    ripple.listen(INTERSECTIONS, noop, {
      events: properties.value.view.events.intersections
    });
