...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    console.log(props.ncId);
    const { ripple } = useEcho(props.ncId);
    ripple.send(READY);
    return (_ctx, _cache) => {
